                ...
                "useNotes.useEffect.fetchNotes": async ()=>{
                    try {
                        ...
                        if (titlesResponse.ok) {
                            ...
                            const notesPromises = titles.map({
                                "useNotes.useEffect.fetchNotes.notesPromises": async (title, index)=>{
                                    try {
                                        const dataResponse = await fetch("http://localhost:5000/data?title=".concat(encodeURIComponent(title)));
                                        if (dataResponse.ok) {
                                        ...
                                        console.error('Failed to fetch data for note "'.concat(title, '":'), error);
                                        return null;
                                    }
                                }
                            }["useNotes.useEffect.fetchNotes.notesPromises"]);
                            const fetchedNotes = await Promise.all(notesPromises);
                            const validNotes = fetchedNotes.filter({
                                "useNotes.useEffect.fetchNotes.validNotes": (note)=>note !== null
                            }["useNotes.useEffect.fetchNotes.validNotes"]);
                            setNotes(validNotes);
                        }
                    } catch (error) {
                        ...
                        if (savedNotes) {
                            const parsedNotes = JSON.parse(savedNotes).map({
                                "useNotes.useEffect.fetchNotes.parsedNotes": (note)=>({
                                        ...note,
                                        createdAt: new Date(note.createdAt),
                                        updatedAt: new Date(note.updatedAt)
                                    })
                            }["useNotes.useEffect.fetchNotes.parsedNotes"]);
...
_s(useNotes, "7KcggcQ5BQyv6pFWzuAXlEmdWCo=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/NotesList.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function NotesList(param) {
    let { notes, selectedNote, onSelectNote, onCreateNote, onDeleteNote } = param;
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: notes.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: notes.map((note)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            className: "p-3 mb-2 rounded-lg cursor-pointer transition-colors group ".concat((selectedNote === null || selectedNote === void 0 ? void 0 : selectedNote.id) === note.id ? 'bg-gray-900 border border-gray-700' : 'hover:bg-gray-900'),
...
function NoteEditor(param) {
    let { note, isEditing, onUpdateNote, onStartEditing, onSaveNote } = param;
    _s();
...
_s(NoteEditor, "s6xv9+LkBWArnjy8QFttJ7dFVj4=");
_c = NoteEditor;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NotesList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/NotesList.tsx [app-client] (ecmascript)");
...
function Home() {
    _s();
    const { notes, selectedNote, isEditing, createNote, updateNote, deleteNote, selectNote, startEditing, saveNote } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNotes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotes"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "h-screen flex bg-black",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NotesList$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                notes: notes,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$NoteEditor$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                note: selectedNote,
                isEditing: isEditing,
...
_s(Home, "HFmQnJByEZpwv9+RSMj04LM5B2k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useNotes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotes"]
    ];
});
_c = Home;
var _c;
...
//# sourceMappingURL=_7f505994._.js.map